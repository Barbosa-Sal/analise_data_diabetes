...
def analise_anova_one_way(
    ...
    if valor_p_f > alfa:
        print(f'Não reita a hipótese nula. (Valor p: {valor_p_f:.3f})')
    else:
...
def analise_wilcoxon(
    ...
    if valor_p_wilcoxon > alfa:
        print(f'Não reita a hipótese nula. (Valor p: {valor_p_wilcoxon:.3f})')
    else:
...
def analise_friedman(
    ...
    if valor_p_friedman > alfa:
        print(f'Não reita a hipótese nula. (Valor p: {valor_p_friedman:.3f})')
    else:
...
def analise_kruskal(
    ...
    if valor_p_kruskal > alfa:
        print(f'Não reita a hipótese nula. (Valor p: {valor_p_kruskal:.3f})')
    else:
